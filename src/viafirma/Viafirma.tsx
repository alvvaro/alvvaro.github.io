      ...
      <main>
        <article className="mt-4 flex flex-col gap-8">
          ...
          <p>
            ...
            <em>information architecture</em>, visual language and vocabulary.
            All the data was already there and was poorly surfaced; the job was
            to review overall page layout, section hierarchies, and component
            interactions.
          </p>
          ...
          <p>
            ...
            <em>data remains one-directional throughout the app tree</em>,
            because revalidations and optimistic updates are handled through a
            provided <pre className="inline">mutate</pre> function.
          </p>
        </article>
      </main>
    </>
